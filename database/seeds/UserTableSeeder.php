...
class UserTableSeeder extends Seeder
{
    ...
    public function __construct()
    {
        ...
        self::$user[5] = ['Pennarun-Leclair', 'Ariane ', 'a.pennarun-leclair@lectra.com', 'woman', 'lectra', 'user'];
        ...
        self::$user[45] = ['Bavoix', 'Marie-Claire ', 'mc.bavoix@lectra.com', 'woman', 'lectra', 'user'];
