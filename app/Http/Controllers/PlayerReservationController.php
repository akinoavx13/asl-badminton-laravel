...
class PlayerReservationController extends Controller
{
    ...
    public static function routes($router)
    {
        ...
        //player reservation edit
        $router->get('/update/{reservation_id}', [
            'uses' => 'PlayerReservationController@edit',
            'as'   => 'playerReservation.edit',
        ]);

        //player reservation update
        $router->post('/update/{reservation_id}', [
            'uses' => 'PlayerReservationController@update',
            'as'   => 'playerReservation.update',
        ]);
    }
    ...
    {
        $reservation = PlayersReservation::findOrFail($reservation_id);
        ...
        return view('reservation.edit', compact('reservation', 'date', 'court', 'timeSlot_id', 'myTeams',
            'teams'));
    }
